...
//           <div className="bg-slate-100 border p-3 rounded-md w-[340px] h-[300px] mx-auto mt-6">
...
//   // UseEffect to load OTP from localStorage if exists
//   useEffect(() => {
//     const storedOtp = localStorage.getItem("otp");
//     if (storedOtp) {
//       setOtp(storedOtp);
...
//     // Show loading spinner while submitting the OTP
//     setLoading(true);
//     setErrorMessage("");  // Reset error message before submitting

//     // Retrieve the access token from localStorage (if required)
//     // const token = localStorage.getItem('acc_token');
...
//          ); // Make sure OTP is passed as a string
...
//             <form onSubmit={handleSubmit}>
//               <div>
//                 <label className="font-semibold text-slate-900" htmlFor="otp"></label>
//                 <input
//                   className="w-60 h-9 mt-1 border rounded-md"
//                   type="text"
//                   value={otp}
...
//               <div className="mt-5 ml-1 flex justify-center">
//                 <button
//                   className={`w-60 h-9 bg-green-500 cursor-pointer text-white font-bold rounded-md text-md ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
//                   type="submit"
